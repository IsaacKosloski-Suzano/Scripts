...
def reorder_columns(input_file, output_file):
    # Load the workbook and ensure there are at least two sheets
    ...
    # Create missing columns with NaN values in the correct order
    for col in missing_cols:
        df2[col] = None
    
    # Reorder columns according to the first sheet
    final_columns = [col for col in col_order] + [col for col in existing_cols if col not in col_order]
    ...
    # Apply styles to missing column headers in the correct order
    ...
    print("Columns reordered and missing columns highlighted in red in the correct order.")

# Example usage:
reorder_columns('data01.xlsx', 'output02.xlsx')
